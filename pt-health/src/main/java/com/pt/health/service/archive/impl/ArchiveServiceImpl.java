...
public class ArchiveServiceImpl implements ArchiveService {
	...
	@Override
	public void updateHealthInfo(JSONObject jsonData) {
		// TODO Auto-generated method stub
		String url = EurekaUtil.getInstance().getServiceUrl(MsApplication.MSARCHIVE, ArchiveApi.UPDATEINFO);
		RestUtil.sendAsyncPut(url, null, jsonData);
	}
